...
<head>
  ...
  <?php require('inc/header.php');?>
    <div class="my-5 px-4">
     <h2 class="fw-bold h-font text-center">Chambres & Suites</h2>
     <hr>
      </div>  
<div class="container-fluid">
 ...
 <div class="col-lg-3 col-md-12 mb-lg-0 mb-4 ps-4">
    ...
    <div class="border bg-light p-3 rounded mb-3">
             ...
             <label class="form-label">Chek-in</label>
             <input type="date" class="form-control shadow-none mb-3">
               <label class="form-label">Chek-out</label>
...
while ($room_data = mysqli_fetch_assoc($room_res)) {
   ...
   <div class="row g-0 p-3 align-items-center">
    ...
    <div class="col-md-2 mt-lg-0 mt-md-0 mt-4 text-center">
      ...
      $book_btn
       <a href="room_details.php?id=$room_data[id]" class="btn btn-sm w-100 text-white custom-bg shadow-none mb-2">More details>>></a>
    </div>
  </div>
</div>
data;
